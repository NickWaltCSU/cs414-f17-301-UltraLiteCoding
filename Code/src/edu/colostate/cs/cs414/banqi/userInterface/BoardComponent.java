	...
	public BoardComponent(Game game, String aUser){
	    ...
	    protected void paintComponent(Graphics g){
	      ...
	      while(graveyardIterator.hasNext()){
	    	  ...
	    	  //Top grave yard
	    	  if(token.getColor()==edu.colostate.cs.cs414.banqi.model.Color.RED){
	    		  if(redX/8==1){
	    			  redX=0;
	    			  redY=1;
	    		  }
	    	  ...
	    	  //Bottom grave yard
	    	  if(token.getColor()==edu.colostate.cs.cs414.banqi.model.Color.BLACK){
	    		  if(blackX/8==1){
	    			  blackX=0;
	    			  blackY=1;
	    		  }
	  ...
	  // token.
	   ...
	   private Color javaColor(edu.colostate.cs.cs414.banqi.model.Color color){
		   if(color==edu.colostate.cs.cs414.banqi.model.Color.RED){
			   return Color.RED;
		   }else{
			   return Color.BLACK;
		   }
